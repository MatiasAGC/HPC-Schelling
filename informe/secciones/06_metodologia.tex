...
La validación usa tres tamaños: mínimo de $8\times6$ durante dos iteraciones, mediano de $256\times160$ durante diez y base de $1024\times640$. Todos emplean la misma semilla por comparación. La primera medición local usa una iteración para comparar el tramo de mayor actividad. También se mide la ejecución completa de 120 meses, porque el trabajo cambia a medida que disminuyen las mudanzas. En FING se realizó primero una pasada corta y luego se repitieron las 120 iteraciones en todas las configuraciones.
