...
Los escenarios usan distancia de Chebyshev con $r=2$, por lo que consideran un cuadrado de hasta 24 vecinos. El peso se calcula con distancia euclidiana y $\sigma=1{,}0$, de modo que los vecinos más lejanos influyen menos. Una variante más cercana al modelo clásico, con radio 1 y pesos uniformes, queda como trabajo futuro.
...
En el escenario funcional, un hogar que se muda queda bloqueado durante los 12 meses siguientes y vuelve a ser elegible en $t+13$. La instancia de rendimiento usa permanencia cero porque las pruebas iniciales mostraron que combinar este bloqueo con las demás restricciones dejaba al sistema sin destinos rápidamente.
